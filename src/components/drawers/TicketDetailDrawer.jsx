    ...
    <React.Fragment>
      {Boolean(tktDrawerOpen) && (
        <div onClick={tktDClose} style={{ position: 'fixed', inset: 0, zIndex: 165, background: 'rgba(31,8,20,.5)', display: 'flex', justifyContent: 'flex-end' }}>
          <div onClick={tktDStop} className="blscroll" style={{ width: '100%', maxWidth: 660, height: '100%', background: '#fff', boxShadow: 'var(--shadow-xl)', overflowY: 'auto', animation: 'blrise .3s var(--ease-out)' }}>
            <div style={{ position: 'sticky', top: 0, background: '#fff', borderBottom: '1px solid var(--line-200)', padding: '18px 24px', zIndex: 3 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
                <div style={{ minWidth: 0 }}>
                  ...
                  <h3 style={{ fontFamily: "'Sora'", fontWeight: 700, fontSize: 19, color: 'var(--beet-700)', margin: '5px 0 0' }}>{tktD.subject}</h3>
            ...
            <div style={{ padding: '18px 24px 34px', display: 'flex', flexDirection: 'column', gap: 15 }}>
              <div style={{ border: '1px solid var(--line-200)', borderRadius: 13, padding: '13px 15px', background: 'var(--surface-50)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 9, flexWrap: 'wrap' }}>
                  {Boolean(tktD.hasTask) && (
                    <button onClick={tktOpenTask} style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '5px 11px', border: '1px solid var(--line-300)', background: '#fff', borderRadius: 9, fontFamily: "'Space Mono'", fontSize: 10.5, fontWeight: 700, color: 'var(--info-600)', cursor: 'pointer' }}>
                  ...
                  {(tktFilesD || []).map((f, i) => (
                    <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '4px 9px', border: '1px solid var(--line-300)', borderRadius: 8, background: '#fff', fontFamily: "'Space Mono'", fontSize: 10, fontWeight: 700, color: 'var(--ink-700)' }}>
                ...
                <div style={{ border: '1px solid var(--line-300)', borderRadius: 14, padding: '14px 16px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 11 }}>
                    <div>
                      ...
                      <select value={tktAssignVal} onChange={tktSetAssign} style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--line-300)', borderRadius: 10, fontSize: 12.5, background: '#fff' }}>
                    ...
                    <div>
                      ...
                      <select value={tktD.status} onChange={tktSetStatus} style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--line-300)', borderRadius: 10, fontSize: 12.5, background: '#fff' }}>
                    ...
                    <div>
                      ...
                      <select value={tktPriorityVal} onChange={tktSetPriorityD} style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--line-300)', borderRadius: 10, fontSize: 12.5, background: '#fff' }}>
                        {(tktPriorityOptionsD || []).map(o => <option key={o} value={o}>{o}</option>)}
                      </select>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                      <button onClick={tktToggleTrainingD} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '9px 11px', border: '1px solid var(--line-300)', background: '#fff', color: 'var(--ink-700)', borderRadius: 10, fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>
                  ...
                  <div style={{ display: 'flex', gap: 9, marginTop: 12, flexWrap: 'wrap' }}>
                    ...
                    <button onClick={tktResolve} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 15px', border: '1px solid #BFE3D0', background: '#fff', color: 'var(--verify-600)', borderRadius: 10, fontSize: 12.5, fontWeight: 700, cursor: 'pointer' }}>
              ...
              {Boolean(tktCanClose) && (
                <div style={{ display: 'flex', gap: 9, flexWrap: 'wrap', borderTop: '1px solid var(--line-200)', paddingTop: 13 }}>
                  ...
                  <button onClick={tktReopen} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', border: '1px solid var(--line-300)', background: '#fff', color: 'var(--ink-700)', borderRadius: 11, fontSize: 12.5, fontWeight: 700, cursor: 'pointer' }}>
