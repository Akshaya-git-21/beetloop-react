...
{(utRows || []).map((r, $i) => (
<div key={$i} style={{"background":"#fff","border":"1px solid var(--line-300)","borderRadius":"14px","boxShadow":"var(--shadow-lg)","padding":"11px 14px","animation":"blrise .25s var(--ease-out)"}}>
