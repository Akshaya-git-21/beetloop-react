...
<div style={{"fontFamily":"'Sora'","fontWeight":"700","fontSize":"17px","color":"var(--beet-700)"}}>{dbTitle}</div>
...
<input type="date" value={dbTeamFrom} onInput={dbTeamSetFrom} style={{"border":"none","background":"none","fontSize":"12.5px","fontWeight":"600","color":"var(--beet-700)","outline":"none"}} />
</div>
<div style={{"display":"flex","alignItems":"center","gap":"7px","background":"#fff","border":"1px solid var(--line-300)","borderRadius":"11px","padding":"6px 10px"}}>
<span style={{"fontSize":"11.5px","fontWeight":"700","color":"var(--ink-500)"}}>To</span>
<input type="date" value={dbTeamTo} onInput={dbTeamSetTo} style={{"border":"none","background":"none","fontSize":"12.5px","fontWeight":"600","color":"var(--beet-700)","outline":"none"}} />
</div>
<button onClick={dbTeamReset} style={{"display":"flex","alignItems":"center","gap":"6px","padding":"7px 12px","border":"1px solid var(--line-300)","background":"#fff","borderRadius":"11px","fontSize":"12px","fontWeight":"700","color":"var(--ink-500)","cursor":"pointer"}}>
...
<div key={$index} style={{"background":"#fff","border":"1px solid var(--line-300)","borderRadius":"16px","boxShadow":"var(--shadow-sm)","overflow":"hidden"}}>
...
<button onClick={m.toggle} style={{"display":"flex","alignItems":"center","gap":"5px","padding":"7px 12px","border":"1px solid var(--line-300)","background":"#fff","color":"var(--ink-700)","borderRadius":"9px","fontSize":"11.5px","fontWeight":"700","cursor":"pointer","flexShrink":"0"}}>
...
{(m.effPlans || []).map((e, $i2) => (
<button key={$i2} onClick={e.open} style={{"display":"inline-flex","alignItems":"center","gap":"6px","padding":"6px 11px","border":"1px solid var(--line-300)","background":"#fff","borderRadius":"9px","fontSize":"11.5px","fontWeight":"700","color":"var(--ink-700)","cursor":"pointer"}}>
...
<div style={{"background":"#fff","border":"1px solid var(--line-200)","borderRadius":"11px","overflow":"hidden"}}>
{(m.taskRows || []).map((t, $i2) => (
...
{Boolean(dbTeamEmpty) && (
<div style={{"background":"#fff","border":"1px solid var(--line-300)","borderRadius":"16px","padding":"40px","textAlign":"center","color":"var(--ink-500)"}}>
...
<div key={$index} onClick={a.open} style={cssTextToObject(`background:#fff;border:1px solid var(--line-300);border-radius:20px;box-shadow:var(--shadow-sm);padding:20px;opacity:${a.opacity};cursor:${a.cursor}`)}>
