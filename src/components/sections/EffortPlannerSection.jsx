...
<button onClick={epRepReset} style={{"display":"flex","alignItems":"center","gap":"6px","padding":"7px 12px","border":"1px solid var(--line-300)","background":"#fff","borderRadius":"11px","fontSize":"12px","fontWeight":"700","color":"var(--ink-500)","cursor":"pointer"}}>
...
<div style={{"fontFamily":"'Sora'","fontWeight":"700","fontSize":"15px","color":"var(--beet-700)"}}>
{p.name}
</div>
...
<select value={epDivision} onChange={epSetDivision} style={{"flexShrink":"0","padding":"10px 12px","border":"none","borderRadius":"11px","fontSize":"13.5px","fontWeight":"700","color":"var(--beet-700)","background":"#fff","cursor":"pointer"}}>
...
<div style={{"display":"flex","alignItems":"center","gap":"10px","background":"#fff","border":"1px solid var(--orchid-300)","borderRadius":"14px","padding":"12px 16px","marginBottom":"18px"}}>
...
<button onClick={epCancelDiv} style={{"padding":"9px 14px","border":"1px solid var(--line-300)","background":"#fff","color":"var(--ink-700)","borderRadius":"10px","fontSize":"12.5px","fontWeight":"700","cursor":"pointer"}}>
Cancel
</button>
...
<button onClick={epResetFilters} style={{"display":"flex","alignItems":"center","gap":"6px","padding":"7px 12px","border":"1px solid var(--line-300)","background":"#fff","borderRadius":"11px","fontSize":"12px","fontWeight":"700","color":"var(--ink-500)","cursor":"pointer"}}>
<Icon name={"rotate-ccw"} style={{"width":"12px","height":"12px"}} />
Reset
</button>
...
<button onClick={epBack} style={{"display":"flex","alignItems":"center","gap":"7px","background":"#fff","border":"1px solid var(--line-300)","color":"var(--ink-700)","borderRadius":"11px","padding":"9px 14px","fontSize":"13px","fontWeight":"700","cursor":"pointer"}}>
...
<div style={{"display":"flex","alignItems":"center","gap":"10px","background":"#fff","border":"1px solid var(--line-300)","borderRadius":"14px","padding":"12px 18px","flex":"1"}}>
...
<div style={{"background":"#fff","border":"1px solid var(--line-300)","borderRadius":"20px","boxShadow":"var(--shadow-sm)","padding":"22px 24px","marginBottom":"16px"}}>

            
<h3 style={{"fontFamily":"'Sora'","fontWeight":"700","fontSize":"16px","color":"var(--beet-700)","margin":"0 0 16px"}}>
1. Plan information
</h3>
...
<input type="month" value={epForm.quarter} onInput={epSetQuarter} style={{"width":"100%","padding":"10px 12px","border":"1px solid var(--line-300)","borderRadius":"11px","fontSize":"13.5px","outline":"none","background":"#fff"}} />
</div>
...
<select value={epForm.owner} onChange={epSetOwner} style={{"width":"100%","padding":"10px 12px","border":"1px solid var(--line-300)","borderRadius":"11px","fontSize":"13.5px","background":"#fff"}}>
...
<input type="date" value={epForm.start} onInput={epSetStart} style={{"width":"100%","padding":"10px 12px","border":"1px solid var(--line-300)","borderRadius":"11px","fontSize":"13.5px","outline":"none","background":"#fff"}} />
</div>
...
<input type="date" value={epForm.end} onInput={epSetEnd} style={{"width":"100%","padding":"10px 12px","border":"1px solid var(--line-300)","borderRadius":"11px","fontSize":"13.5px","outline":"none","background":"#fff"}} />
</div>
...
<select value={epForm.type} onChange={epSetType} style={{"width":"100%","padding":"10px 12px","border":"1px solid var(--line-300)","borderRadius":"11px","fontSize":"13.5px","background":"#fff"}}>
<option>
Monthly
</option>
<option>
...
<div style={{"background":"#fff","border":"1px solid var(--line-300)","borderRadius":"20px","boxShadow":"var(--shadow-sm)","overflow":"hidden","marginBottom":"16px"}}>

            
<div style={{"padding":"20px 24px 14px"}}>
<h3 style={{"fontFamily":"'Sora'","fontWeight":"700","fontSize":"16px","color":"var(--beet-700)","margin":"0"}}>
...
<input value={r.type} onInput={r.setType} style={{"flex":"1","minWidth":"140px","padding":"7px 9px","border":"1px solid transparent","borderRadius":"8px","fontSize":"13px","fontWeight":"700","color":"var(--ink-900)","outline":"none","background":"none"}} style-focus="border-color:var(--orchid-300);background:#fff" />
</span>
</td>
...
<td style={{"padding":"11px 14px","borderBottom":"1px solid var(--line-200)"}}>
<span style={{"fontSize":"13px","fontWeight":"700","color":"var(--beet-700)"}}>
{r.daily}
</span>
...
<td style={{"padding":"11px 14px","borderBottom":"1px solid var(--line-200)"}}>
<input value={r.unit} onInput={r.setUnit} style={{"width":"88px","padding":"7px 9px","border":"1px solid transparent","borderRadius":"8px","fontSize":"12.5px","color":"var(--ink-500)","outline":"none","background":"none"}} style-focus="border-color:var(--orchid-300);background:#fff" />
</td>
...
{Boolean(r.canRemove) && (
<React.Fragment>
<button onClick={r.remove} title="Remove effort" style={{"width":"30px","height":"30px","borderRadius":"8px","border":"1px solid var(--line-300)","background":"#fff","cursor":"pointer","display":"inline-flex","alignItems":"center","justifyContent":"center"}}>
...
<h3 style={{"fontFamily":"'Sora'","fontWeight":"700","fontSize":"16px","color":"var(--beet-700)","margin":"0 0 14px"}}>
3. Target allocation
</h3>
...
<span style={{"marginLeft":"auto","fontSize":"11.5px","fontWeight":"800","color":"var(--beet-700)"}}>
{a.weight}
</span>
</div>
...
<button onClick={epGenerate} style={{"flexShrink":"0","display":"flex","alignItems":"center","gap":"8px","background":"#fff","color":"var(--beet-700)","border":"none","borderRadius":"12px","padding":"12px 20px","fontSize":"14px","fontWeight":"700","cursor":"pointer"}}>
